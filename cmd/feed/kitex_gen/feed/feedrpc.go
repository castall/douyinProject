...
func (p *FeedServiceFeedMethodArgs) InitDefault() {
	*p = FeedServiceFeedMethodArgs{}
}
...
func (p *FeedServiceFeedMethodArgs) SetRequest(val *FeedReq) {
	p.Request = val
}
...
func (p *FeedServiceFeedMethodArgs) DeepEqual(ano *FeedServiceFeedMethodArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceFeedMethodArgs) Field1DeepEqual(src *FeedReq) bool {
...
func (p *FeedServiceFeedMethodResult) InitDefault() {
	*p = FeedServiceFeedMethodResult{}
}
...
func (p *FeedServiceFeedMethodResult) SetSuccess(x interface{}) {
...
func (p *FeedServiceFeedMethodResult) DeepEqual(ano *FeedServiceFeedMethodResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceFeedMethodResult) Field0DeepEqual(src *FeedResp) bool {
